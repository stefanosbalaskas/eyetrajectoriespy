...
def test_version_and_public_symbols():
    ...
    required={
        "FunctionalMixedEffectsFullRefitBootstrapResult","bootstrap_functional_mixed_effects_full_refit","functional_mixed_effects_full_refit_audit_frame","functional_mixed_effects_variance_bootstrap_frame","compare_functional_mixed_effects_bootstraps",
