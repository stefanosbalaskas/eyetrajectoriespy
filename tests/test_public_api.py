...
def test_version_and_public_symbols():
    ...
    required={
        ...
        "FPCARegressionCVResult","FPCARegressionUncertaintyResult","FPCANestedRegressionCVResult",
        "bootstrap_fpca_regression_uncertainty","fpca_regression_slope_uncertainty_frame","fpca_regression_prediction_uncertainty_frame","plot_fpca_regression_slope_uncertainty","plot_fpca_regression_mean_prediction_uncertainty","fpca_regression_uncertainty_reporting_text","cross_validate_fpca_regression","summarise_fpca_regression_cv",
