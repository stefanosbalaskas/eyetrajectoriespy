...
def test_version_and_public_symbols():
    ...
    required={
        "FunctionalMixedEffectsFullRefitBootstrapResult","bootstrap_functional_mixed_effects_full_refit","functional_mixed_effects_variance_bootstrap_frame","functional_mixed_effects_bootstrap_identity_frame","functional_mixed_effects_full_refit_reporting_text","compare_functional_mixed_effects_bootstraps","plot_functional_mixed_effects_bootstrap_comparison",
