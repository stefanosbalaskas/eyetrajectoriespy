...
def test_version_and_public_symbols():
    assert et.__version__=="0.34.0.dev0"
    required={
        ...
        "TrajectorySet","DiscreteFrechetResult","DynamicTimeWarpingResult","discrete_frechet_distance","pairwise_discrete_frechet_distances","dynamic_time_warping_distance","pairwise_dynamic_time_warping_distances","plot_dynamic_time_warping_alignment","dynamic_time_warping_reporting_text","fit_fpca","fit_mfpca","fit_multilevel_fpca","fit_compositional_fpca","FPCAScoreUncertaintyResult","FPCASpectrumUncertaintyResult",
