...
def test_version_and_public_symbols():
    assert et.__version__=="0.24.0.dev0"
    required={
        "MathematicalContract","get_mathematical_contract","list_mathematical_contracts","mathematical_contract_frame",
        "DelayEmbeddingResult","EmbeddingDelayDiagnosticResult","EmbeddingDimensionDiagnosticResult","RecurrenceResult","RQAResult","WindowedRQAResult","WindowedRQAFunctionalResult",
        ...
        "recurrence_matrix","rqa_metrics","windowed_rqa","windowed_rqa_trajectory_set","cross_recurrence_matrix","cross_rqa_metrics",
        ...
        "plot_embedding_delay_diagnostics","plot_embedding_dimension_diagnostics","plot_recurrence","plot_windowed_rqa","plot_windowed_rqa_trajectories",
        "plot_local_divergence","plot_surrogate_nonlinearity","plot_poincare_return_map",
        "rqa_reporting_text","windowed_rqa_reporting_text","windowed_rqa_functional_reporting_text","largest_lyapunov_reporting_text",
