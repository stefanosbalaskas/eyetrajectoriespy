...
def test_version_and_public_symbols():
    assert et.__version__=="0.32.0.dev0"
    required={
        ...
        "TrajectorySet","DiscreteFrechetResult","discrete_frechet_distance","pairwise_discrete_frechet_distances","fit_fpca","fit_mfpca","fit_multilevel_fpca","fit_compositional_fpca","FPCAScoreUncertaintyResult","FPCASpectrumUncertaintyResult",
