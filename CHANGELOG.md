...
- explicit fit/score smoothing settings, PACE tolerance, normalization flag, and backend-version provenance;
...
- backend-independent fake-FDApy contract tests plus a dedicated real-FDApy integration workflow for Python 3.11–3.13;
