...
The MCSE and exact Clopper-Pearson limits are written explicitly in the [mathematical reference](../methods/mathematical-reference.md#finite-bootstrap-monte-carlo-precision).
