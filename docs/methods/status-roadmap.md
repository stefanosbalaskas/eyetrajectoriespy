...
| Discrete Fréchet trajectory distance | implemented; order-preserving sampled-route metric, timestamps excluded | `discrete_frechet_distance()` / `pairwise_discrete_frechet_distances()` |
