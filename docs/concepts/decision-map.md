...
| How does a repeated binary or count functional response change with trial-varying scalar predictors? | marginal generalized function-on-scalar GEE | participant is the independent cluster; declare Bernoulli/logit or Poisson/log and the coefficient basis; for Poisson rates supply explicit positive exposure; working independence + robust sandwich |
