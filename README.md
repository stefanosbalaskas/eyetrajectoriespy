...
| Variance-component-aware repeated-trial bootstrap | whole-participant full mixed-model refit + covariance stability audit + fixed-vs-full band comparison | `bootstrap_functional_mixed_effects_full_refit()` / `compare_functional_mixed_effects_bootstraps()` |
